...
\begin{itemize}
  \item \textbf{K1:} enduring entities capable of bearing obligations
        or responsibilities.
  \item \textbf{K2:} enduring physical or operational entities that
        may be acted upon but do not bear obligations.
  \item \textbf{K3:} enduring authority-bearing structures that
        ground obligations or permissions independently of any particular
        occurrence.
  \item \textbf{K4:} time-indexed actions or events whose identity
        is inseparable from temporal realization and provenance.
  \item \textbf{K5:} enduring applicability contexts that delimit where,
        to whom, or under what conditions instruments apply.
  \item \textbf{K6:} descriptive records or measurements that assert
        observed or derived facts without asserting causal or normative claims.
\end{itemize}

These six regimes correspond directly to the six capacities derived in
Section~\ref{sec:requirements}:
obligation-bearing capacity (K1),
acted-upon reference (K2),
normative grounding without execution (K3),
time-indexed occurrence (K4),
applicability and scope (K5), and
descriptive indication without causal commitment (K6).

Each regime fixes a distinct identity criterion that is invariant under
incompatible extension.
No entity changes regime over time, and no regime's identity conditions
depend on interpretation supplied by analytic or application layers.
...
Indicators are not taken to measure occurrences directly in the substrate.
Occurrences serve as temporal and provenance anchors for indicators,
while measurements target enduring referents whose identity
...
Non-redundancy follows from the necessity argument:
each regime is required by at least one of R2--R6,
so omitting any regime would violate a stated requirement.
\end{proof}
