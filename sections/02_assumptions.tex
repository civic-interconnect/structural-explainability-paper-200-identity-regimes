...
annotations, but it must not change its ontological status
(i.e., its identity conditions or persistence regime)
in order to remain usable as a shared referent.
